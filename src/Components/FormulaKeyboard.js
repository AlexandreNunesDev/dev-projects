    ...
    return (
        <Container>
            ...
            <Row> 
                ...
                <GenericDropDown display={"Materia Prima"} returnType={"fatorTitulometrico"} showType={"nome"}  key={'ddMp'} itens={props.meteriasPrima || []} onChoose={props.onMateriaPrimaChoosen} ></GenericDropDown>
            </Row>
